...
JOBS = [
    ...
    ("bot_de_rejilla_acciones", "scripts.study_grid_stock", "Bot de rejilla en acciones laterales (DOC/FRT/PPL): mejor que en cripto, pero sigue perdiendo frente a comprar y mantener"),
    ("bot_de_rejilla_regimen", "scripts.study_grid_regime", "Grid + filtro de régimen (se apaga en tendencia) en BTC/ETH: mejora en BTC, falla en ETH, rechazado por falta de robustez"),
